...
export const api_v1_hi_list = createAsyncThunk("his/api_v1_hi_list", async payload => {
  const response = await apiService.api_v1_hi_list(payload);
  return response.data;
});
export const api_v1_hi_create = createAsyncThunk("his/api_v1_hi_create", async payload => {
  const response = await apiService.api_v1_hi_create(payload);
  return response.data;
});
export const api_v1_hi_retrieve = createAsyncThunk("his/api_v1_hi_retrieve", async payload => {
  const response = await apiService.api_v1_hi_retrieve(payload);
  return response.data;
});
export const api_v1_hi_update = createAsyncThunk("his/api_v1_hi_update", async payload => {
  const response = await apiService.api_v1_hi_update(payload);
  return response.data;
});
export const api_v1_hi_partial_update = createAsyncThunk("his/api_v1_hi_partial_update", async payload => {
  const response = await apiService.api_v1_hi_partial_update(payload);
  return response.data;
});
export const api_v1_hi_destroy = createAsyncThunk("his/api_v1_hi_destroy", async payload => {
