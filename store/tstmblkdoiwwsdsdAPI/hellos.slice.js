...
export const api_v1_hello_list = createAsyncThunk("hellos/api_v1_hello_list", async payload => {
  const response = await apiService.api_v1_hello_list(payload);
  return response.data;
});
export const api_v1_hello_create = createAsyncThunk("hellos/api_v1_hello_create", async payload => {
  const response = await apiService.api_v1_hello_create(payload);
  return response.data;
});
export const api_v1_hello_retrieve = createAsyncThunk("hellos/api_v1_hello_retrieve", async payload => {
  const response = await apiService.api_v1_hello_retrieve(payload);
  return response.data;
});
export const api_v1_hello_update = createAsyncThunk("hellos/api_v1_hello_update", async payload => {
  const response = await apiService.api_v1_hello_update(payload);
  return response.data;
});
export const api_v1_hello_partial_update = createAsyncThunk("hellos/api_v1_hello_partial_update", async payload => {
  const response = await apiService.api_v1_hello_partial_update(payload);
  return response.data;
});
export const api_v1_hello_destroy = createAsyncThunk("hellos/api_v1_hello_destroy", async payload => {
